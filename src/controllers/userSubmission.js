...
const submitCode = async (req,res)=>{
  ...
  //  combine the code 
   const startCodeBlock = problem.startCode.find(sc => sc.language.toLowerCase() === language);
  if (startCodeBlock && startCodeBlock.boilerCode) {
    code = startCodeBlock.boilerCode.replace('{userCode}', code);
  }
